...
public class Detalle extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtArticulo9 = new javax.swing.JLabel();
        ...
        txtPrecioSinIVA9 = new javax.swing.JLabel();
        ...
        txtPrecio9 = new javax.swing.JLabel();
        ...
        txtDescuento9 = new javax.swing.JLabel();
        ...
        txtPagar9 = new javax.swing.JLabel();
        ...
        txtArticulo5.setText("Papas Fritas");
        getContentPane().add(txtArticulo5, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 260, 110, -1));
        ...
        getContentPane().add(txtTotalPagar, new org.netbeans.lib.awtextra.AbsoluteConstraints(640, 410, 120, -1));

        txtArticulo6.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtArticulo6.setText("Banana");
        getContentPane().add(txtArticulo6, new org.netbeans.lib.awtextra.AbsoluteConstraints(7, 290, 80, -1));

        txtArticulo7.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtArticulo7.setText("Lechuga");
        getContentPane().add(txtArticulo7, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 320, 80, -1));

        txtArticulo8.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtArticulo8.setText("Huevo");
        getContentPane().add(txtArticulo8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 350, 80, -1));

        txtArticulo9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtArticulo9.setText("Cebolla");
        getContentPane().add(txtArticulo9, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 380, 70, -1));
        ...
        getContentPane().add(txtCantidad5, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 260, 20, -1));
        ...
        getContentPane().add(txtCantidad6, new org.netbeans.lib.awtextra.AbsoluteConstraints(160, 290, 40, -1));
        ...
        getContentPane().add(txtCantidad7, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 320, 20, -1));
        ...
        getContentPane().add(txtCantidad8, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 350, 20, -1));

        txtCantidad9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtCantidad9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtCantidad9.setText("0");
        getContentPane().add(txtCantidad9, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 380, 20, -1));
        ...
        getContentPane().add(txtPrecioSinIVA5, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 260, 40, -1));
        ...
        getContentPane().add(txtPrecioSinIVA6, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 290, 40, -1));
        ...
        getContentPane().add(txtPrecioSinIVA7, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 320, 40, -1));
        ...
        getContentPane().add(txtPrecioSinIVA8, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 350, 40, -1));

        txtPrecioSinIVA9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtPrecioSinIVA9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtPrecioSinIVA9.setText("₲0");
        getContentPane().add(txtPrecioSinIVA9, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 380, 40, -1));
        ...
        getContentPane().add(txtPrecio5, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 260, 40, -1));
        ...
        getContentPane().add(txtPrecio6, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 290, 40, -1));
        ...
        getContentPane().add(txtPrecio7, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 320, 40, -1));
        ...
        getContentPane().add(txtPrecio8, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 350, 40, -1));

        txtPrecio9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtPrecio9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtPrecio9.setText("₲0");
        getContentPane().add(txtPrecio9, new org.netbeans.lib.awtextra.AbsoluteConstraints(350, 380, 40, -1));
        ...
        getContentPane().add(txtDescuento5, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 260, 30, -1));
        ...
        getContentPane().add(txtDescuento6, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 290, 30, -1));
        ...
        getContentPane().add(txtDescuento7, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 320, 30, -1));
        ...
        getContentPane().add(txtDescuento8, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 350, 30, -1));

        txtDescuento9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtDescuento9.setForeground(new java.awt.Color(255, 255, 255));
        txtDescuento9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtDescuento9.setText("₲0");
        getContentPane().add(txtDescuento9, new org.netbeans.lib.awtextra.AbsoluteConstraints(490, 380, 30, -1));
        ...
        txtPagar5.setText("₲0");
        getContentPane().add(txtPagar5, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 260, 40, -1));
        ...
        txtPagar6.setText("₲0");
        getContentPane().add(txtPagar6, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 290, 40, -1));
        ...
        txtPagar7.setText("₲0");
        getContentPane().add(txtPagar7, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 320, 40, -1));
        ...
        txtPagar8.setText("₲0");
        getContentPane().add(txtPagar8, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 350, 40, -1));

        txtPagar9.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        txtPagar9.setForeground(new java.awt.Color(255, 255, 255));
        txtPagar9.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        txtPagar9.setText("₲0");
        getContentPane().add(txtPagar9, new org.netbeans.lib.awtextra.AbsoluteConstraints(710, 380, 40, -1));
    ...
    public void cantidades(String cantidad1, String cantidad2, String cantidad3, String cantidad4, String cantidad5, String cantidad7, String cantidad6, String cantidad8){
        ...
        txtPrecioSinIVA2.setText("5000");
        txtPrecioSinIVA3.setText("12000");
        txtPrecioSinIVA4.setText("7000");
        txtPrecioSinIVA5.setText("10000");
        txtPrecioSinIVA6.setText("5000");
        txtPrecioSinIVA7.setText("5000");
        txtPrecioSinIVA8.setText("25000");
    
        
        
        //precios + iva
        float p1 = 13000f + (13000f*0.10f);
        float p2 = 5000f + (5000f*0.10f);
        float p3 = 12000f + (12000f*0.10f);
        float p4 = 7000f + (7000f*0.10f);
        float p5 = 10000f + (10000f*0.10f);
        float p6 = 5000f + (5000f*0.10f);
        float p7 = 5000f + (5000f*0.10f);
        float p8 = 25000f + (25000f*0.10f);
    ...
    private javax.swing.JLabel txtArticulo9;
    ...
    private javax.swing.JLabel txtDescuento9;
    ...
    private javax.swing.JLabel txtPagar9;
    ...
    private javax.swing.JLabel txtPrecio9;
    ...
    private javax.swing.JLabel txtPrecioSinIVA9;
    private javax.swing.JLabel txtTotalPagar;
    // End of variables declaration//GEN-END:variables

    void cantidades(String cantidad9) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }

    void cantidades(String cantidad1, String cantidad2, String cantidad3, String cantidad4) {
        throw new UnsupportedOperationException("Not supported yet."); // Generated from nbfs://nbhost/SystemFileSystem/Templates/Classes/Code/GeneratedMethodBody
    }
}
